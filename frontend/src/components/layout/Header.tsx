  ...
  return (
    <header className="h-14 border-b border-[#0d331d]/80 bg-[#03130a]/88 backdrop-blur-2xl flex items-center justify-between px-4 sm:px-6 z-30 shadow-[0_4px_20px_rgba(0,0,0,0.4)] sticky top-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-semibold uppercase tracking-wider border font-mono bg-[#00ff66]/15 text-[#00ff66] border-[#00ff66]/40 shadow-[0_0_12px_rgba(0,255,102,0.25)]">
