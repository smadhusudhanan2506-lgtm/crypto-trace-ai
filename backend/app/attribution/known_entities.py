...
KNOWN_ENTITIES = [
    ...
    # =========================================================================
    {
        ...
        "addresses": [
            ...
            {"address": "TRFU4mQ37a5DbQYhgUXYtNkyJ5pa29ua13", "chain": "tron", "label": "Binance Tron Hot Wallet 1 (USDT)", "source": "TronGrid verified"},
            {"address": "TDii6vao7xyWg2rKPbCPWVRpSmne8xcqYx", "chain": "tron", "label": "Binance Tron Hot Wallet 2", "source": "TronGrid verified"},
            {"address": "TPYSmva97u7gs3X658tN8dK642xZpTfh9t", "chain": "tron", "label": "Binance Tron Hot Wallet (Legacy Alias)", "source": "TronScan label"},
            {"address": "TNDc5k2mfLvyvVw8E18x5HqXmH8zF3zMps", "chain": "tron", "label": "Binance Tron Hot Wallet 3", "source": "TronScan verified"},
            {"address": "9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM", "chain": "solana", "label": "Binance Solana Hot Wallet 1", "source": "Solscan verified"},
            {"address": "5tzFkiKscXHK5ZXCGbXZxdw7gTjjD1mB726oWokFmcKK", "chain": "solana", "label": "Binance Solana Hot Wallet 2", "source": "Solscan verified"},
        ],
        "confidence": 0.98,
